    ...
    <div className="rounded-2xl border border-slate-200 bg-white p-3 shadow-sm">
      ...
      <div className="mt-3 grid gap-2">
        ...
        <button
          ...
          className="rounded-xl bg-indigo-700 px-3 py-2 text-sm font-medium text-white hover:bg-indigo-800"
        >
        ...
        <button
          ...
          className="rounded-xl bg-orange-700 px-3 py-2 text-sm font-medium text-white hover:bg-orange-800"
        >
        ...
        <button
          ...
          className="rounded-xl bg-amber-700 px-3 py-2 text-sm font-medium text-white hover:bg-amber-800"
        >
          Send for Dilation
        </button>
